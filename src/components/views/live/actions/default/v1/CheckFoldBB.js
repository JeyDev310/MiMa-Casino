...
const CheckFoldBBDefaultToggle = React.forwardRef(({
  props,
  onClick,
  disabled,
}, ref) => {
...
const CheckFoldBBDefaultMenu = React.forwardRef(({
  props,
  close,
  reset,
  className,
...
class CheckFoldBBDefault extends Component {
    ...
    return (
      <>
        ...
        <Dropdown
          ...
          <Dropdown.Toggle
            as={CheckFoldBBDefaultToggle}
            props={this.props}
            disabled={this.props.disabled} />

          <Dropdown.Menu
            alignRight
            as={CheckFoldBBDefaultMenu}
            className="mb-2"
            props={this.props}
...
export default CheckFoldBBDefault