...
class PlayerOrbit extends Component {
  ...
  constructor(props) {
    ...
    this.handleRenderSeat = this.handleRenderSeat.bind(this)
    this.handleSwitchPlayerList = this.handleSwitchPlayerList.bind(this)
  ...
  getSeatTransform(pos) {
    switch (pos) {
      case 1:
        return `translate(-50%, -50%) translate(-75%, -200%)`
      case 2:
        return `translate(-50%, -50%) translate(75%, -200%)`
      case 3:
        return `translate(-50%, -50%) translate(125%, 0%)`
      case 4:
        return `translate(-50%, -50%) translate(75%, 200%)`
      case 5:
        return `translate(-50%, -50%) translate(-75%, 200%)`
      ...
      return (
        <span
          ...
          style={{
            ...
            borderRadius: "15px",
            opacity: `0.75`,
            transform: this.getSeatTransform(seat),
            width: '256px',
          }}>
    ...
    return (
      <>
        ...
        {this.props.game.data && this.props.game.data.auto_mode && (
          <Card.Body className="align-content-center w-100 h-100 position-absolute">
            <Card className="d-flex align-items-center justify-content-center w-100 h-100 mb-0 bg-transparent border-0 shadow-none">
              <div className="d-flex align-items-center justify-content-center">
                <div className="ava_s2 auth-loader-layout-s2" style={{
                  left: "50%",
                  top: "50%",
                  ...
                  <img
                    src={`${process.env.PUBLIC_URL}/img/section/live/game/app-panel-logo-size-1.png`}
                    className="avatar-bet-timer-scale-x-animation" alt="Live App" style={{ width: "100%", minHeight: "100%" }}
                  />
                </div>
              </div>
            </Card>
