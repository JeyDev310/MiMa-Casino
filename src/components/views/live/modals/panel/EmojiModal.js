...
const CustomToggle = React.forwardRef(({
  ...
  <Button
    ...
    <i className="fas fa-smile" style={{ fontSize: "1.2rem", }} />
  </Button>
))
      ...
      <div
        ...
        <PerfectScrollbar
          ...
          <div style={{
            ...
            <Card
              className="d-flex w-100 bg-transparent border-0 shadow-none"
              style={{
                borderRadius: "15px",
              }}>
                  ...
                  .map((icon, index) => (
                    <Col
                      ...
                      <Button
                        ...
                        <Card
                          className="d-inline-flex justify-content-center align-items-center bg-light card-hover">
                          <Emoji
                            symbol={icon[1]}
                            className="px-2 py-1" />
                        </Card>
