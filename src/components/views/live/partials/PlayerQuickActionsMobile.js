...
class PlayerQuickActionsMobile extends Component {
  ...
  render() {
    return (
      <>
        ...
        <div className="d-flex align-items-center justify-content-center p-0 m-0 w-100 player-quick-actions-mobile-parent-s1">
          <span
            id="nav-link-1"
...
export default PlayerQuickActionsMobile