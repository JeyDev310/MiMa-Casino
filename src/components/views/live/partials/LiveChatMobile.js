...
class LiveChatMobile extends Component {
  ...
  render() {
    return (
      <div style={{minWidth: "315px", zIndex: "9999"}}>
        {this.props.game.messages && (
          <div className='d-flex'>
            <div onClick={e => this.props.change('optionD4', !this.props.settings.optionD4)} className="mr-3" style={{marginTop: "160px"}}>
            ...
            {this.state.visible && this.props.settings.optionD4 && this.props.settings.optionF7 && (
              <>
                ...
                <Card
                  className="border-0 shadow-none p-1 mb-0 cursor-pointer"
                  style={{                    
                  ...
                  <span className="d-flex align-items-center justify-content-between bg-transparent pl-1">
                    <span className="mb-0 ml-1">
                      <span className="d-flex align-items-center">
                        ...
                        <span className="ml-1 mb-0 font-weight-bold">
                          <div>
                            <div style={{ fontSize: "10px", fontWeight: "800", lineHeight: "0px",
                            }}>
                              Live Chat
                              <Badge
                                pill variant="default"
                                className="falign-text-bottom ml-2 cursor-pointer" style={{fontSize: "10px", fontWeight: "700",background: "#FFFFFF", color: "#000000"}}>
                    ...
                    <div>
                      <span
                        className="text-muted small mt-0 cursor-pointer font-weight-bold mr-1"
                        onClick={e => this.props.openSlide(4)}>
                        <img src={`${process.env.PUBLIC_URL}/svg/icons/open-in-full.svg`} alt="Full view Icon" style={{width: "12px"}}/>                            
                      </span>
                      <Form.Label
              ...
              <div className="flex-grow-0 py-0 pr-0 pl-lg-0 livechat-panel-opacity-animation">
                <Media className="align-items-center">
                  <Button
                    ...
                    className="py-1 px-3 d-flex align-items-center justify-content-center border-0 mb-0 small w-100"
                    disabled={false}
                    onClick={() => { this.handleChangeChannel('system') }}>
                    <span style={{fontSize: "7px", fontWeight: "700", display: "inline",  whiteSpace: "nowrap"}}>
                      System Messages
                    </span>
                  </Button>
                  <Button
                    ...
                    className="py-1 d-flex align-items-center justify-content-center border-0 mb-0 small w-100"
                    disabled={false}
            ...
            {/* Live Chat Messages */}
            <div className="flex-grow-1 position-relative" style={{minHeight: "115px"}}>
              {this.state.visible && this.props.settings.optionD4 && this.props.settings.optionF7 && (
                <div>
                  <PerfectScrollbar
                    options={{
                    ...
                    {this.state.channel === 'system' && (
                      <div className="chat-contents-mobile">
            ...
            {this.props.settings.optionD4 && this.props.settings.optionF7 && (
              <div className="pt-0 livechat-panel-opacity-animation">
                  ...
                  <Card.Footer
                    ...
                    <span className="d-flex w-100">
                      <ButtonGroup size="sm" className="w-100">
                        ...
                        <div style={{transform: "translate(0%, 0%) scale(0.6, 1)"}}>
