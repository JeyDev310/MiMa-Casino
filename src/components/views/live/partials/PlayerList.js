...
class PlayerList extends Component {
  ...
  getItemActionIndicator(item) {
    if (item.p_action === "Bet") return (<>      
      <div variant="opaque4" className="ml-1" style={{color: "#E48023", fontWeight: "600"}}>Bet</div>      
    </>)
    if (item.p_action === "Check") return (<>
      <div variant="opaque5" className="ml-1" style={{color: "#FE9600", fontWeight: "600"}}>Check</div>
    </>)
    if (item.p_action === "Raise") return (<>
      <div variant="opaque4" className="ml-1" style={{color: "#46CB6B", fontWeight: "600"}}>Raise</div>
    </>)
    if (item.p_action === "Re-Raise") return (<>
      <div variant="opaque4" className="ml-1" style={{color: "#46CB6B", fontWeight: "600"}}>Re-Raise</div>
    </>)
    if (item.p_action === "Call") return (<>
      <div variant="opaque6" className="ml-1" style={{color: "#FFDA1B", fontWeight: "600"}}>Call</div>
    </>)
    if (item.p_action === "Fold") return (<>
      <div variant="opaque7" className="ml-1" style={{color: "#DE4A4A", fontWeight: "600"}}>Fold</div>
    </>)
    if (item.p_action === "All In") return (<>
      <div pill variant="opaque8" className="ml-1" style={{color: "#4FC7EC", fontWeight: "600"}}>All In</div>
    </>)
    if (item.p_action === "Exited") return (<>
      <div pill variant="opaque7" className="ml-1" style={{color: "#DE4A4A", fontWeight: "600"}}>Exit</div>
    </>)
    return null
  }
...
AvatarPlaceholder (pos) {
    ...
    if (item) {
      return item.p_action === "Fold" ? <>
        ...
        <span
          ...
          <div className="position-relative">
            ...
            <div className="d-flex flex-column justify-content-center text-center rounded-circle" style={{width: "5rem",height: "5rem", border: "0.18rem solid #DE4A4A", background: "#131313"}}>            
            <img src={`data:image/jpeg;base64, ${this.props.game.profile.avatar}`} className="rounded-circle" alt="User" style={{filter: "brightness(50%)"}}/> 
            </div>
          </div>          
        ...
        <span
          ...
          <div className="position-relative">
            ...
            <div className="d-flex flex-column justify-content-center text-center rounded-circle" style={{width: "5rem",height: "5rem", border: "0.18rem solid #DE4A4A", background: "#131313"}}>
            <img src={`${process.env.PUBLIC_URL}/svg/avatars/${this.AvatarPlaceholder(seat)}.svg`} className="rounded-circle" alt="User" style={{filter: "brightness(50%)"}}/>
            </div>
          </div>          
       ...
       : item.username === this.props.game.profile.username ? (
        <div
          ...
          <div className="position-relative">
            ...
            {this.getItemPanelBackground(item) === null ? <div className="d-flex justify-content-center text-center rounded-circle" style={{width: "5rem",height: "5rem", border: "0.18rem solid #4FC7EC", background: "#131313"}}>
              <img src={`data:image/jpeg;base64, ${this.props.game.profile.avatar}`} className="rounded-circle" alt="User" />
            </div> 
            : 
            <div className="d-flex justify-content-center text-center rounded-circle player-list-active-seat" style={{width: "5rem",height: "5rem", border: "0.18rem solid #4FC7EC", background: "#131313"}}>
              <img src={`data:image/jpeg;base64, ${this.props.game.profile.avatar}`} className="rounded-circle" alt="User" />
            </div>}
        ...
        (
          <div
            ...
            <div className="position-relative">
              ...
              <div className="d-flex" style={{position: "absolute", bottom: "0.43rem", right: "-1.25rem"}}>
                <img src={`${process.env.PUBLIC_URL}/svg/cards/X.svg`} alt="Card Back" style={{width: "1.25rem"}} />
                <img src={`${process.env.PUBLIC_URL}/svg/cards/X.svg`} alt="Card Back" style={{width: "1.25rem", marginLeft: "-0.25rem"}} />
              </div>
              {this.getItemPanelBackground(item) === null ? 
                <div className="d-flex justify-content-center text-center rounded-circle" style={{width: "5rem",height: "5rem", border: "0.19rem solid #4FC7EC", background: "#131313"}}>                
                  <img src={`${process.env.PUBLIC_URL}/svg/avatars/${this.AvatarPlaceholder(seat)}.svg`} className="rounded-circle" alt="User" />
                </div>
                : <div className="d-flex justify-content-center text-center rounded-circle player-list-active-seat" style={{width: "5rem",height: "5rem", border: "0.18rem solid #4FC7EC", background: "#131313"}}>                
                <img src={`${process.env.PUBLIC_URL}/svg/avatars/${this.AvatarPlaceholder(seat)}.svg`} className="rounded-circle" alt="User" />
                </div>}
      ...
      return (
        <span
          ...
          <div className="position-relative">
            <div className="d-flex flex-column justify-content-center text-center rounded-circle" style={{width: "5rem",height: "5rem", border: "0.18rem solid #4FC7EC", background: "#131313"}}>
        ...
        return (
            <div
              ...
              <div className="position-relative">
                ...
                <div className="d-flex justify-content-center text-center rounded-circle" style={{width: "5rem",height: "5rem", border: "0.18rem solid #4FC7EC", background: "#131313"}}>
                  {item.username === this.props.game.profile.username ?
                  <img src={`data:image/jpeg;base64, ${this.props.game.profile.avatar}`} className="rounded-circle" alt="User" />
                  : <img src={`${process.env.PUBLIC_URL}/svg/avatars/${this.AvatarPlaceholder(seat)}.svg`} className="rounded-circle" alt="User" />}
                </div>
  ...
  render(seat) {        
    ...
    // console.log('sidePor----------->', this.props.game.evaluation.pot_summary.details)             
    return (
      <div className="player-list-Large-layout-s1">
        {this.props.game.data && (
          <>
            {/* Player List */}
            {!this.state.init
                ...
                <div className="position-relative">
                  <PerfectScrollbar
                    ...
                    {this.props.settings.optionD11 && (
                      <div style={{position: "relative", width: "30rem", height: "37rem", display: "flex", justifyContent: "center", alignItems: "center"}}>
                        <div style={{width: "22rem", height: "31rem", border: "0.2rem solid #4FC7EC", borderRadius: "5.8rem", background: "rgba(0, 0, 0, 0.6)", display: "flex", justifyContent: "center", alignItems: "center"}}>
                          <div className="d-flex flex-column align-items-center">
                            ...
                            {/* / Cards Panel */}                            
                            {/* <span className="d-flex font-weight-bold" style={{ marginTop:"5px", fontSize: "1rem", color: "#FFFFFF" }}>
                              <div className="px-4">Split1</div>
                              <div className="px-4">Split2</div>
                            </span>                                                  */}
                          </div>
                        </div>
                    ...
                    {/* {true && (
                      <div className="pt-1 pb-2" style={{ zIndex: "99999", }}>
                        <PlayerNotifications
              ...
              : <>
                <div className="flex-grow-1 position-relative ">
                  <PerfectScrollbar
                    ...
                    {this.props.settings.optionD11 && (
                      <div style={{position: "relative", width: "30rem", height: "37rem", display: "flex", justifyContent: "center", alignItems: "center"}}>
                        <div style={{width: "22rem", height: "31rem", border: "0.2rem solid #4FC7EC", borderRadius: "5.8rem", background: "rgba(0, 0, 0, 0.6)"}}></div>
                        {this.getSeatCountArr()
