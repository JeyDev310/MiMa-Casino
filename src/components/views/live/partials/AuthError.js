...
class AuthError extends Component {
  ...
  constructor(props) {
    ...
    this.onHandlePageRefresh = this.onHandlePageRefresh.bind(this)
          ...
          <div className="authentication-inner py-2 auth-loader-layout-s1">
            <Card className="" style={{
              ...
              <Card.Body className="px-5 pt-5 pb-4 mb-2">
                ...
                <div className="d-flex align-items-center justify-content-center pt-2 mb-4">
                  <img
                    src={`${process.env.PUBLIC_URL}/img/section/live/empty/cloud-update-512-1.png`}
                ...
                <form>
                  <div className="d-flex justify-content-center align-items-center">
                    <p className="text-white text-center font-weight-bold mb-1 h5">
                      Please try again later
                    </p>
                  </div>
                  <div className="d-flex justify-content-center align-items-center">
                    <p className="text-white text-center font-weight-semibold mb-0 opacity-50 h6">
                      Game not available
                    </p>
                  </div>
                </form>
