     ...
     : item.username === this.props.game.profile.username ? (
      <div
        ...
        <div className="position-relative" style={{marginLeft: "10rem"}}>
          ...
          : 
            <img src={`data:image/jpeg;base64, ${this.props.game.profile.avatar}`} className="rounded-circle player-list-active-seat" alt="User" style={{width: "5rem",height: "5rem", border: "0.18rem solid #4FC7EC"}}/>
          }
        ...
        {this.props.game.data && (
          <>
            ...
            {!this.state.init
              ? <>
                <div
                  className="flex-grow-1 position-absolute player-list-mobile-layout-s1">
                  <div
              ...
              : <>
                <div
                  className="position-absolute player-list-mobile-layout-s1">
                  <div
                    className="chat-contacts list-group chat-scroll py-1 justify-content-start position-relative player-list-mobile-layout-s2">                    
                    {/* Player List Main */}
                    {this.props.settings.optionD11 && (
                      <div style={{position: "relative", width: "30rem", height: "37rem", display: "flex", justifyContent: "center", alignItems: "center"}}>
