...
import FoldOptionalCheckModal from '../modals/panel/FoldOptionalCheckModal'
import FoldOptionalBBCheckModal from '../modals/panel/FoldOptionalBBCheckModal'
...
class GameActionsPanel extends Component {
  ...
  constructor(props) {
    ...
    this.renderGameActionCheckFold = this.renderGameActionCheckFold.bind(this)
    this.renderGameActionBBCheckFold = this.renderGameActionBBCheckFold.bind(this)
  ...
  renderGameActionCheckFold() {
    return (
      <FoldOptionalCheckModal {...this.props} />
    )
  }

  renderGameActionBBCheckFold() {
    return (
      <FoldOptionalBBCheckModal {...this.props} />
    )
  }
        ...
        case SYNC_TYPE_ACTIONS_PANEL_CHECKABLE_FB:
          return (
            <React.Fragment>
              ...
              {this.renderGameActionCheckFold()}
        ...
        case SYNC_TYPE_ACTIONS_PANEL_BIG_BLIND_CHECKABLE:
          return (
            <React.Fragment>
              ...
              {this.renderGameActionRaise()}
              {this.renderGameActionBBCheckFold()}
              {this.renderGameActionAllIn()}
            </React.Fragment>
          )
              ...
              <Col>
                <div className="flex-grow-1 position-relative">
                  <span
                    ...
                    style={{
                      backgroundColor: "rgba(37, 40, 46, 0.80)",
                      borderWidth: "0px",
