...
class WithdrawalFormPlaceholder extends Component {
        ...
        <Form.Group as={Row} className="mt-2">
          ...
          <Col sm={10}>
            ...
            <div className="text-left text-white opacity-100 font-weight-bold h5 mb-5">
              Please select a valid method to proceed with the withdrawal.
            </div>
...
export default withRouter(connect(mapStateToProps, { objectsRequestHandler })(WithdrawalFormPlaceholder))