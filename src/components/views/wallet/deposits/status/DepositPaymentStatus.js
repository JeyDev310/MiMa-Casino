...
class WalletPaymentStatus extends Component {
  ...
  onRenderPaymentStatusText() {
    if (this.state.status === 'success') {
      ...
      return ('Sorry, your transaction was canceled.')
    } else {
  ...
  onRenderPaymentStatusIcon() {
    if (this.state.status === 'success') {
      ...
      return (
        <div className="d-flex justify-content-center align-items-center mt-4 mb-2 py-2 mb-0">
          <ResourceLoaderN height={`8rem`} width={`8rem`} />
        </div>
      )
    } else if (this.state.status === 'failed') {
      return (
                ...
                ? <>
                  ...
                  <form>
                    ...
                    {this.state.response && (
                      <Form.Group>
                        <Row className="w-100">
                          <Col xs={6} sm={6} md={6} lg={6} className="d-flex align-items-center justify-content-start mb-1">
                            <div className="ml-0">
                    ...
                    {this.state.status !== 'success' && (
                      <div className="d-flex justify-content-between align-items-center m-0 mb-2">
                        <Button
                          ...
                          onClick={() => {
                            this.onHandleRefreshItems()
                          }}>
                          <span className="fas fa-sync-alt text-body mr-2"></span>
