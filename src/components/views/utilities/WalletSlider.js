      ...
      <>
        <Swiper {...swiperWithArrows}>
          <Card className="text-left mb-3 p-4 border-0" style={{
            ...
            backgroundImage: `url(${process.env.PUBLIC_URL}/img/packages/deficons/png/front/10.png)`,
          }} >
            <Card.Header className="border-0">
              <img
                src={`${process.env.PUBLIC_URL}/img/uikit/logo-light-img-1-1-0.png`}
                className="d-block ui-w-60" alt="Logo" />
            </Card.Header>
            <Card.Body>
          ...
          <Card className="text-left mb-3 p-4 border-0" style={{
            ...
            <Card.Body>
              <Card.Title as="h3">How to Play</Card.Title>
              <Card.Text className="text-body h6">
                From hand rankings to basic rules and strategies, find everything you need to get started.
                <br />
                <span className="small">If you’re new to online poker, we’re here to help you learn.</span>
              </Card.Text>
              <Button
                variant="info rounded-pill font-weight-bold"
