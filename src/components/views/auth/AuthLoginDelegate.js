...
class AuthenticationLoginDelegate extends Component {

  constructor(props) {
    super(props)
    props.setTitle('Login Delegate')
  ...
  handleSubmit(e) {
    ...
    if (
      ...
      this.state.credentials.delegate &&
  ...
  onHandleSetInputFocus(e, position) {
    if (position === 'username') {
      if (e.key === 'Enter') {
        ReactDOM.findDOMNode(this.delegateRef).focus()
      }
      if (e.key === 'Tab') {
        e.stopPropagation()
        e.preventDefault()
                ...
                <form className="my-4">
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      onKeyDown={(e) => { this.onHandleSetInputFocus(e, 'username') }}
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      ref={c => (this.delegateRef = c)}
                      value={this.state.credentials.delegate}
                      onChange={e => this.onValueChange('delegate', e)}
                      onKeyDown={(e) => { this.onHandleSetInputFocus(e, 'delegate') }}
                      className="font-weight-bold"
                      maxLength="128" />
                  </Form.Group>
