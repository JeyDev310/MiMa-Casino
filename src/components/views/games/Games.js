...
import LatestGames from '../utilities/sliders/LatestGames'
...
class GamesListView extends Component {
  ...
  constructor(props) {
    ...
    this.onStoriesModalClose = this.onStoriesModalClose.bind(this)

    this.state = {
      init: false,
      username: null,
      viewMode: 'col',
      storiesModalShow: false,
    }
  }
    ...
    this.props.objectsRequestHandler(
      ...
      this.setState({
        ...
        this.showToastify(<>
          <div className="cursor-pointer p-0 m-0 small">
            <h6>
              Live Poker Studio™ Live Games
            </h6>
            <p className="mb-0">
              Live Games have been updated successfully.
            </p>
          </div>
        </>, 'info')
      })
  ...
  getCardThumbnail(id) {
    if (id in Array.from(Array(11).keys())) {
      return `url('${process.env.PUBLIC_URL}/img/cards/games/tables/0.jpg')`
    } else {
      return `url('${process.env.PUBLIC_URL}/img/cards/games/tables/0.jpg')`
    }
  }
  ...
  onStoriesModalClose() {
    this.setState({ storiesModalShow: false, })
  }
    ...
    return (
      <div>
        ...
        {this.state.init && (
          <>
            <h5 className="font-weight-bold py-2 mb-2 d-flex justify-content-between align-items-center">
              ...
              <span className="ml-auto d-flex align-items-center justify-content-center">
                <Button
                            ...
                            <div className="w-100">
                              <Link
                                ...
                                <span
                                  ...
                                  style={{
                                    borderRadius: "10px",
                                    backgroundImage: this.getCardThumbnail(game.table_id),
                                    objectFit: "cover",
                                    height: "300px",
                                  }}>
                        ...
                        <ContextMenu
                          ...
                          {this.onEvaluateGameIsJoinable(game)
                            ? (<MenuItem
                              ...
                              <span className="font-weight-semibold">Play Now</span>
                            </MenuItem>)
                            : (<MenuItem
                              data={{ itemNo: 'play_now', }}
                              onClick={this.prevent} disabled>
                              <span className="font-weight-semibold">No Free Seats</span>
                            </MenuItem>)}
                          <SubMenu
                            title={
                              <span className="font-weight-semibold">Profile</span>
                            }>
                            <MenuItem
                              ...
                              <span className="font-weight-semibold">Statistics</span>
                            </MenuItem>
                            <MenuItem
                              ...
                              <span className="font-weight-semibold">Transactions</span>
                            </MenuItem>
                            <MenuItem
                              ...
                              <span className="font-weight-semibold">Game History</span>
                            </MenuItem>
                            <MenuItem
                          ...
                          <MenuItem
                            ...
                            <span className="font-weight-semibold">Settings</span>
                          </MenuItem>
                        </ContextMenu>
                      </Col>
                    ))}
              ...
              : <>
                ...
                <Row>
                  <Col
                    ...
                    <ContextMenu id={`item-context-index-placeholder`}>
                      <MenuItem
                        data={{ itemNo: 'play_now', }}
                        onClick={this.prevent} disabled>
                        <span className="font-weight-semibold">No Games Available</span>
                      </MenuItem>
                      <SubMenu
                        title={
                          <span className="font-weight-semibold">Profile</span>
        ...
        <Modal
          ...
          show={this.state.storiesModalShow}
          size="xl"
          onHide={this.onStoriesModalClose}>
          <button
            type="button"
            className="close"
            aria-label="Close"
            onClick={this.onStoriesModalClose}>
            &times;
          </button>
...
export default withRouter(connect(mapStateToProps, { objectsRequestHandler })(GamesListView))