      ...
      <React.Fragment>
        <div className="authentication-wrapper authentication-3">
          <div className="authentication-inner">
            ...
            {/* Form container */}
            <div className="d-flex col-lg-4 align-items-center p-5" style={{
                ...
                <div className="w-100">
                  ...
                  <div className="my-4">
                        ...
                        <div className="w-100 position-relative" style={{ paddingBottom: '10%', }}>
                          <Link to='/'>
                            <img
                              ...
                              alt="Live Poker Studio™" className="d-block ui-w-120" />
                          </Link>
                        </div>
                      </div>
                    </div>
                    ...
                    <p className="text-left small mb-4">
                      The page you are looking for does not exist. How you got here is a mystery. But you can click the button below to go back to Live Poker Studio™.
                    </p>
                          ...
                          <div className="ui-w-60">
                            <div className="w-60 position-relative">
                              <img
                                ...
                                alt="Live Poker Studio™" className="d-block ui-w-60" />
                            </div>
                          </div>
                        </div>
                      </Col>
            ...
            {/* Side container */}
            <div
              className="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5 bg-lighter"
              style={{
                backgroundImage: `url('${process.env.PUBLIC_URL}/img/packages/ambient/ambient-1912935526-0002.jpg')`,
